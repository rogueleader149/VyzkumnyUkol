...
\usepackage{amsmath, amsthm, amssymb, units, dsfont, algorithmicx, algpseudocode}   % dsfont pro indikátor jevu
\usepackage[pdftex,
...
\newcommand{\klicova}{}
\newcommand{\keyword}{}
\newcommand{\abstrCZ}{Bla bla abstrakt CZ.}
\newcommand{\abstrEN}{Bla bla abstrakt EN.}
%%% k vyplnění KONEC ---------------------------------------------------
...
\begin{center}
	...
	\includegraphics[height=75pt]{lev.eps} \\[100pt]
...
%%% ÚVODEM
\input{./include/0-prolog.tex}

%%% KAPITOLA 1 -- Úvod
\input{./include/1-overview.tex}

%%% KAPITOLA 2 -- Testy
\input{./include/2-comp_power.tex}

%%% ZÁVĚREM
\input{./include/n-1-epilog.tex}
