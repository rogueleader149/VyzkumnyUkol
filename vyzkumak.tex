...
\usepackage{amsmath, amsthm, amssymb, units, dsfont, algorithmicx, algpseudocode, nomencl, nicefrac}   % dsfont pro indikátor jevu
\usepackage[pdftex,
...
%%% KAPITOLA 2
\input{./include/2-strand_models.tex}

%%% KAPITOLA 3
\input{./include/3-wang-tile_models.tex}

%%% KAPITOLA 4
\input{./include/4-results.tex}
