...
\begin{center}
	...
	\end{subfigure}
	\caption{Evolution of $\myatam$ model from DAE units to tiles. Here glues {\sf A}, {\sf B}, {\sf G} and {\sf J} are of strength $2$.} %!% okomentovat že se nic neposere těma lepidlama = 2 na krajích
	\label{fig:evolution}
\end{center}
\end{figure}
