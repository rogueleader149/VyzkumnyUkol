...
\begin{description}
	...
	\item[Glue complexity] ... total number of used glue types. The higher glue complexity the higher number of DNA letters in the sticky end sequence. % něco citovat co zminuje závislost P_chyby na dýlce sekvence
\end{description}
