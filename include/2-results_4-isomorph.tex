...
\begin{description}
	...
	\begin{description}
		...
		% there is some redundancy .. but no idea how to do it faster .. it can be done easier, one can only verify without colors, same colors are killed during ordering!
	\end{description}
