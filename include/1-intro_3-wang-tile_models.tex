...
\subsection{Definition}
	...
	\begin{description}
		\item[Deterministic] iff there exists unique terminal tiling over $T$. % (in other words, reachability relation has one minimal/maximal member).
...
\subsection{Computational power}\label{sec:wang_power}
	...
	\subsubsection{Turing universality of 2D tiles at $T=2$}
		...
		% this simulation runs with polynomial delay
