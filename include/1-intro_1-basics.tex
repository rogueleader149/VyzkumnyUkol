...
\section{Complexity, languages}
	...
	\label{sec:PNP}
		...
		This section describes few classes of languages from the resource-consumption point of view. Note that all of these sets are a subset of recursively enumerable languages. There exist many equivalent definitions, these are taken from \cite{book_comp}. % The first set of definitions is very straightforward and thus can be used for propositions.
